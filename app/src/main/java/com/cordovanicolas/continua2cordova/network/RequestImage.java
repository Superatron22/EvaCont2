...
import com.cordovanicolas.continua2cordova.application.SocialApplication;

public class RequestImage {
    private static RequestImage instance = null;
    ...
    private RequestImage() {
        context = SocialApplication.getAppContext();
